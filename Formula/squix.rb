class Squix < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/eduardofuncao/squix/releases/download/v0.4.1-test/squix-darwin-amd64"
      sha256 "3740d4e73d45db94c107055807c9d80e36eaa828933aca69738d3510d7b1e099"
    else
      url "https://github.com/eduardofuncao/squix/releases/download/v0.4.1-test/squix-darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/eduardofuncao/squix/releases/download/v0.4.1-test/squix-linux-amd64"
      sha256 "b951c31629494d0a7530bd812e972de759e530da6e9fb4cbea2b62203257ae1b"
    else
      url "https://github.com/eduardofuncao/squix/releases/download/v0.4.1-test/squix-linux-arm64"
